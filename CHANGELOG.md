...
- Build: initial entry 306.56 KiB against the 350 KiB budget (the new `Reader` chunk is lazy-loaded at 26.8 KiB); `build.py` validation passes with the desktop shell required in the payload
