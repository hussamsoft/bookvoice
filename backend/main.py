...
from routes import access, audiobooks, books, config, ocr, server, studio, translation, tts, updates, voices
...
app.include_router(audiobooks.router, prefix="/api/books", tags=["audiobooks"])
